...
class CredisCardForm extends React.Component{
    constructor(props) {
        super(props)
        this.state = {
            value: "",
    ...
    renderSuccess() {
        return(
            <div>
                ...
                <button type="submit" className="btn btn-success btn-larget" onClick={() => {this.props.toggle()}}>
                    OK
                </button>
            </div>
        )
...
export default function CreditCardInformation(props) {
    ...
    const CCFormWithStripe = injectStripe(CredisCardForm)
